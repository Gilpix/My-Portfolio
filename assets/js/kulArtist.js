...
var projectDetails = [
	{
		id: "0",
		name: "TP3 - CMS",
		heading: "Full-Stack Developer (contract) <br>  ReactJS, NodeJs, MongoDB, Ant Design, CMS, ExpressJs, Redux Toolkit, RTK Query, Postman, Selenium, MongoDb, Python, Swagger, Gitlab, Docker, VS Code",
		description: "It is the ultimate one-stop solution that prepares children for school and life and supports parental engagement. I am working as a full-stack developer, developing Content Management System (CMS) for the top parent mobile app.<br>-> Contributed in all phases of the development lifecycle <br>->Developed a Content Management System (CMS) for the top parent mobile app using ReactJS for the front end and Node.js for the back end.<br>->Implemented serverless architecture by deploying the backend services on AWS Lambda, optimizing scalability and reducing operational costs.<br>->Leveraged AWS Route53 and Amplify for deploying and hosting the frontend application, ensuring seamless deployment and continuous integration.<br>->Designed and implemented the database architecture using MongoDB, ensuring efficient data storage and retrieval for the CMS.<br>->Utilized Swagger for API documentation, ensuring clear and comprehensive documentation for backend APIs, facilitating easier integration and maintenance.<br>->Developed reusable React components and utilized state management libraries such as Redux toolkit for maintaining application state, enhancing code modularity and reusability.<br>->Implemented authentication and authorization mechanisms to secure the CMS, ensuring data integrity and user privacy.<br>->Optimized application performance by identifying and resolving bottlenecks in both frontend and backend components.<br>->Stayed updated with the latest technologies and industry trends, continuously improving skills and contributing to the innovation culture of the team.<br>->Conducted performance tuning and optimization techniques, such as lazy loading and code splitting, to enhance the overall user experience and reduce load times.<br>->Developed detailed system architecture diagrams, illustrating the interaction between frontend and backend components, database structures, and external services.<br>->Documented deployment processes and procedures, including setup instructions for AWS Lambda functions, Amplify hosting configurations, and MongoDB database setup, facilitating smooth deployment and maintenance.<br>->Designed and documented technical specifications, system architecture, and deployment processes to ensure clear understanding and seamless execution throughout the project lifecycle.",
		demo: "https://www.piknix.com",
		code: "https://www.piknix.com",
		image: "top_parent.png",
...
var projectInfo = [
	{
		id: "0",
		title: "TP3-CMS",
		languages: "Full-Stack Developer at Top Parent",
		category: "web",
		icon: "<i class='fas fa-2x fa-graduation-cap'></i><br>",
